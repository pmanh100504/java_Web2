          ...
          <div className="row no-gutters">
            <div className="col-md-3">
              <div className="home-category-banner bg-light-orange">
                ...
                <img src={require("../../assets/images/items/2.jpg")}className="img-bg" alt="Machinery items" />
              </div>
            </div>
                ...
                <li className="col-6 col-lg-3 col-md-4">
                  <a href="#" className="item">
                    <div className="card-body">
                      ...
                      <img className="img-sm float-right" src={require("../../assets/images/items/2.jpg")} alt="Well made electronic stuff" />
                ...
                <li className="col-6 col-lg-3 col-md-4">
                  <a href="#" className="item">
                    <div className="card-body">
                      ...
                      <img className="img-sm float-right" src={require("../../assets/images/items/2.jpg")} alt="Another demo text" />
                ...
                <li className="col-6 col-lg-3 col-md-4">
                  <a href="#" className="item">
                    <div className="card-body">
                      ...
                      <img className="img-sm float-right" src={require("../../assets/images/items/2.jpg")} alt="Home and kitchen electronic stuff" />
                ...
                <li className="col-6 col-lg-3 col-md-4">
                  <a href="#" className="item">
                    <div className="card-body">
                      ...
                      <img className="img-sm float-right" src={require("../../assets/images/items/2.jpg")} alt="Group of electronic stuff" />
